...
class FetchReachAndThrowFixCgbrEnv(fetch_env.FetchEnv, ut.EzPickle):
    ...
    def _reset_sim(self):
        ...
        if ((self.success > 50) and (self.change_list == 0)):
            with open('List_path_fix_cgbr_large_1_2.csv','w') as file:
                
                write = csv.writer(file)
                write.writerow(self.save_list)
                self.change_list = 1
                
            with open('List_path_fix_cgbr_large_1_pos_x_2.csv','w') as file_x:
                
                write_x = csv.writer(file_x)
                write_x.writerow(self.x_list)
                
            with open('List_path_fix_cgbr_large_1_pos_y_2.csv','w') as file_y:
                
                write_y = csv.writer(file_y)
                write_y.writerow(self.y_list)
                
        if ((self.success > 100) and (self.change_list == 1)):
            with open('List_path_fix_cgbr_large_2_2.csv','w') as file:
                
                write = csv.writer(file)
                write.writerow(self.save_list)
                self.change_list = 2
                
            with open('List_path_fix_cgbr_large_2_pos_x_2.csv','w') as file_x:
                
                write_x = csv.writer(file_x)
                write_x.writerow(self.x_list)
                
            with open('List_path_fix_cgbr_large_2_pos_y_2.csv','w') as file_y:
                
                write_y = csv.writer(file_y)
                write_y.writerow(self.y_list)
                
        if ((self.success > 150) and (self.change_list == 2)):
            with open('List_path_fix_cgbr_large_3_2.csv','w') as file:
                
                write = csv.writer(file)
                write.writerow(self.save_list)
                self.change_list = 3
                
            with open('List_path_fix_cgbr_large_3_pos_x_2.csv','w') as file_x:
                
                write_x = csv.writer(file_x)
                write_x.writerow(self.x_list)
                
            with open('List_path_fix_cgbr_large_3_pos_y_2.csv','w') as file_y:
                
                write_y = csv.writer(file_y)
                write_y.writerow(self.y_list)
                
        if ((self.success > 200) and (self.change_list == 3)):
            with open('List_path_fix_cgbr_large_4_2.csv','w') as file:
                
                write = csv.writer(file)
                write.writerow(self.save_list)
                self.change_list = 4
                
            with open('List_path_fix_cgbr_large_4_pos_x_2.csv','w') as file_x:
                
                write_x = csv.writer(file_x)
                write_x.writerow(self.x_list)
                
            with open('List_path_fix_cgbr_large_4_pos_y_2.csv','w') as file_y:
                
                write_y = csv.writer(file_y)
                write_y.writerow(self.y_list)
                
        if ((self.success > 250) and (self.change_list == 4)):
            with open('List_path_fix_cgbr_large_5_2.csv','w') as file:
            ...
            with open('List_path_fix_cgbr_large_5_pos_x_2.csv','w') as file_x:
                
                write_x = csv.writer(file_x)
                write_x.writerow(self.x_list)
                
            with open('List_path_fix_cgbr_large_5_pos_y_2.csv','w') as file_y:
                
                write_y = csv.writer(file_y)
                write_y.writerow(self.y_list)
                
        if ((self.success > 300) and (self.change_list == 5)):
            with open('List_path_fix_cgbr_large_6_2.csv','w') as file:
                
                write = csv.writer(file)
                write.writerow(self.save_list)
                self.change_list = 6
                
            with open('List_path_fix_cgbr_large_6_pos_x_2.csv','w') as file_x:
                
                write_x = csv.writer(file_x)
                write_x.writerow(self.x_list)
                
            with open('List_path_fix_cgbr_large_6_pos_y_2.csv','w') as file_y:
